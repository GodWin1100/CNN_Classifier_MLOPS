...
class Training:
    ...
    def train_valid_generator(self):
        ...
        self.valid_generator = valid_datagenerator.flow_from_directory(
            ...
            subset="validation",  # will create validation set but all augmentation will be applied to validation dataset also
            shuffle=False,
            **dataflow_kwargs,
        )
        if self.config.params_is_augmentation:
            # ? use `tf.keras.utils.image_dataset_from_directory` and apply augmentation via layers
